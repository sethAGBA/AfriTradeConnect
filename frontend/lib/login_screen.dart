...
import 'package:jwt_decode/jwt_decode.dart'; // Ajout pour décoder le token
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('Connexion réussie, navigation vers HomeScreen');
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    Icon(Icons.connecting_airports, size: 64, color: Colors.blue.shade700),
                    SizedBox(height: 16),
                    Text(
                      'AfriTrade Connect',
                      style: TextStyle(
